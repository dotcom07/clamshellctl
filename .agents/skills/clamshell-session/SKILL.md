...
description: Use before long-running local macOS work such as AI agent runs, builds, tests, downloads, scripts, or background tasks when MacBook sleep, closed-lid behavior, display brightness, or audio mute may matter. Do not use for short commands or remote/cloud-only work.
---
